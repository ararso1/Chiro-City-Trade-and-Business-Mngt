...
let BusinessesController = class BusinessesController {
    ...
    findAll(search, status, traderId, skip, take) {
...
__decorate([
    (0, common_1.Post)(),
    (0, permissions_decorator_1.RequirePermissions)('businesses.create', '*'),
...
__decorate([
    (0, common_1.Get)(),
    (0, permissions_decorator_1.RequirePermissions)('businesses.read', '*'),
    __param(0, (0, common_1.Query)('search')),
    __param(1, (0, common_1.Query)('status')),
    __param(2, (0, common_1.Query)('traderId')),
...
__decorate([
    (0, common_1.Put)(':id'),
    (0, permissions_decorator_1.RequirePermissions)('businesses.update', '*'),
    __param(0, (0, common_1.Param)('id')),
